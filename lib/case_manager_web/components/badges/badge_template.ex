defmodule CaseManagerWeb.BadgeTemplate do
  ...
  @container_classes "inline-flex items-center justify-center rounded-[5px] focus:outline-none h-6 px-[5px] gap-[5px]"
  @txt_classes "text-black text-xs font-semibold"
  @icon_classes "w-6 h-6 relative"
  ...
  defp badge_classes(opts) do
    ...
    [@container_classes, @txt_classes, custom_classes]
  end
