defmodule CaseManagerWeb.CoreComponents do
  ...
  def flash(assigns) do
    ...
    ~H"""
    <div :if={msg = render_slot(@inner_block) || Phoenix.Flash.get(@flash, @kind)} id={@id} phx-click={JS.push("lv:clear-flash", value: %{key: @kind}) |> hide("##{@id}")} role="alert" class="toast toast-top toast-end z-50" {@rest}>
      <div class={[
  ...
  def button(%{rest: rest} = assigns) do
    ...
    custom_class = rest[:class] || ""
    assigns = assign(assigns, :class, [variant_class, custom_class])
